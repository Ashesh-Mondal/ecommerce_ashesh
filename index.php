      ...
      <div class="row">
        ...
        ?>
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <div class="img-box">
                <img src="./admin/inc/p_destination/<?php echo $row['pimage'] ?>" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  <?php echo $row['pname']; ?>
              ...
              <h6>
                Price <span style="margin-left: 85px;">&#8377;<?php echo $row['price']; ?></span>
              </h6>
              <div>
                ...
                <?php } else { ?>
                  <a class="btn btn-dark form-control" style="color: #fff; cursor: pointer" onclick="abc();">Buy Now</a>
                <?php } ?>
              </div>
