...
<body>
    ...
    <section class="saving_section" style="margin-top: 50px;">
        <div class="box">
        ...
        <div class="container">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $result = $conn->query("SELECT p.pname, p.pimage, s.id AS sub_order_id ,s.master_id, s.product_id, s.quantity, s.price, m.* FROM product AS p INNER JOIN sub_order AS s ON s.product_id=p.id INNER JOIN master_order AS m ON s.master_id=m.id WHERE m.customer_id='$customer_id'");
